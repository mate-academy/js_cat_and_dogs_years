...
describe('getHumanAge', () => {
  ...
  test(`should return 0 if cat and dog are 0 year old`, () => {
    expect(getHumanAge(0, 0))
      .toStrictEqual([0, 0]);
  });

  test(`should return 0 if cat and dog are < 15 years old`, () => {
    expect(getHumanAge(14, 14))
      .toStrictEqual([0, 0]);
  });

  test(`should return 1 if cat and dog are 15 years old`, () => {
    expect(getHumanAge(15, 15))
      .toStrictEqual([1, 1]);
  });

  test(`should return 1 if cat and dog are 23 years old`, () => {
    expect(getHumanAge(23, 23))
      .toStrictEqual([1, 1]);
  });

  test(`should return 2 if cat and dog are 24 years old`, () => {
    expect(getHumanAge(24, 24))
      .toStrictEqual([2, 2]);
  });

  test(`should return [2, 2] if cat and dog are 27 years old`, () => {
    expect(getHumanAge(27, 27))
      .toStrictEqual([2, 2]);
  });

  test(`should return [3, 2] if cat and dog are 28 years old`, () => {
