...
describe('getHumanAge', () => {
  ...
  test('should return an array', () => {
    expect(Array.isArray(getHumanAge(1, 2)))
      .toBe(true);
  });

  test('should convert cat and dog years to human years', () => {
    expect(getHumanAge(1, 1))
      .toEqual([0, 0]);
  });

  test(`should convert cat and dog years to human years
    with whole number of years, discard the remainder`, () => {
    expect(getHumanAge(17, 18))
      .toEqual([1, 1]);
  });
  ...
  test('should return [3, 3] for ages 29, 29', () => {
    expect(getHumanAge(28, 28)).toEqual([3, 2]);
  });
