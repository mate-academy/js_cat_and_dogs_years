...
describe('getHumanAge', () => {
  ...
  test('should return an array [0, 0] values if ages are 0', () => {
    expect(getHumanAge(0, 0)).toEqual([0, 0]);
  });

  test('should return an array [0, 0] values if ages are 14', () => {
    expect(getHumanAge(10, 9)).toEqual([0, 0]);
  });

  test('should return an array with values [1, 1] if ages are 15', () => {
    expect(getHumanAge(15, 15)).toEqual([1, 1]);
  });

  test('should return an array with values [1, 1] if ages are 23', () => {
    expect(getHumanAge(23, 23)).toEqual([1, 1]);
  });

  test('should return an array with values [2, 2] if ages are 24', () => {
    expect(getHumanAge(24, 24)).toEqual([2, 2]);
  });

  test('should return an array with values [2, 2] if ages are 27', () => {
