...
describe('getHumanAge', () => {
  ...
  test('returns [0, 0] when both cat and dog ages are 14', () => {
  ...
  test('returns [1, 1] when both cat and dog ages are 23', () => {
  ...
  test('returns [21, 18] when cat age is 28 and dog age is 100', () => {
