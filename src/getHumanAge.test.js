...
describe('getHumanAge', () => {
  ...
  test('should return 0 for both cat and dog age < 15', () => {
  ...
  test('should not change progression step after 24 years', () => {
    ...
    for (let i = 1; i <= 5; i++) {
      ...
      expect(getHumanAge(24 + catThirdFactor * i, 24 + dogThirdFactor * i))
        .toEqual([targetHumanAge, targetHumanAge]);
    }
  });

  test('should diverge ages between cat and dog after 27 for equal steps',
    () => {
      const baseAge = 27;
