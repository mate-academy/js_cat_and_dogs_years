...
describe('getHumanAge', () => {
  ...
  test(`should return [0, 0] of human age for cat's and dog's
   years less than 15`,
  () => {
  ...
  test(`should return [1, 1] of human year for 15 cat's and dog's years`,
    () => {
      expect(getHumanAge(15, 15))
        .toEqual([1, 1]);
    });

  test(`should return [1, 1] human year for cat's and dog's age 
  between 15 and 23 years inclusivly`, () => {
    expect(getHumanAge(23, 16))
      .toEqual([1, 1]);
  });

  test(`should return [2, 2] human years for 24 cat's and dog's years`, () => {
    expect(getHumanAge(24, 24))
      .toEqual([2, 2]);
  });

  test(`should return [2, 2] human years for cat's age between 24 and 27
