...
describe('getHumanAge', () => {
  ...
  it(`'should return an array of 2 zero
   if catAge & dogAge less than 15'`, () => {
    expect(getHumanAge(14, 14))
      .toEqual([0, 0]);
  });

  it(`'should return an array of 2 units
  ...
  it(`'should return an array of 2 deuces
  ...
  it(`'should return an array with elements 6 & 5
