...
describe('getHumanAge', () => {
  ...
  test('should return 0 for inputs < 15', () => {
    expect(getHumanAge(14, 5))
      .toEqual([0, 0]);
  });

  test('should return 1 for inputs equal 15', () => {
    expect(getHumanAge(15, 15))
      .toEqual([1, 1]);
  });

  test('should return 1 for inputs >=15 and < 24', () => {
    expect(getHumanAge(19, 23))
      .toEqual([1, 1]);
  });

  test('should return 2 for inputs equal 24', () => {
