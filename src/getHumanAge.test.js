...
describe('getHumanAge', () => {
  ...
  test('should return [2, 2] when input is (27, 28)', () => {
    expect(getHumanAge(27, 28))
      .toEqual([2, 2]);
  });

  test('should return [3, 3] when input is (28, 29)', () => {
    expect(getHumanAge(28, 29))
      .toEqual([3, 3]);
  });

  test('should return [13, 13] when input is (70, 80)', () => {
    expect(getHumanAge(70, 80))
      .toEqual([13, 13]);
  });
});
