...
describe('getHumanAge', () => {
  ...
  test('should return [0, 0] when both catAge and dogAge are 14', () => {
  ...
  test('should return [2, 2] when both catAge and dogAge are 27', () => {
    expect(getHumanAge(27, 27)).toEqual([2, 2]);
  });

  test('should return [3, 2] when both catAge and dogAge are 28', () => {
