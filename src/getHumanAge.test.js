...
describe('getHumanAge', () => {
  ...
  test('should return [0, 0] for catAge=14, dogAge=14', () => {
  ...
  test('should return [1, 1] for catAge=23, dogAge=23', () => {
  ...
  test('should return [2, 2] for catAge=27, dogAge=27', () => {
    expect(getHumanAge(27, 27)).toEqual([2, 2]);
  });

  test('should return [3, 2] for catAge=28, dogAge=28', () => {
